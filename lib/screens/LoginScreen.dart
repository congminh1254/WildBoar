...
import 'package:wild_boar/util/bubble_indication_painter.dart';
import 'package:wild_boar/util/theme.dart';
...
class _LoginPageState extends State<LoginPage>
  ...
  _submit1() {
    ...
    //print(_name);
    print(signupNameController.toString().trim());
    //print(_password);
    AuthService.signUpUser(
      context,
      signupNameController.text.toString().trim(),
      signupEmailController.text.toString().trim(),
      signupPasswordController.text.toString().trim(),
    );
  }
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
                      if (validateEmail(
                        ...
                        showInSnackBar(
                            "Invalid email or password is less than 6 characters");
                      }
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () {
                      if (validateEmail(
                              signupEmailController.text.toString().trim()) &&
                          (signupNameController.text.length > 3) &&
